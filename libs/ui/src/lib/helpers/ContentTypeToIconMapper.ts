...
export const mapContentTypeToIcon = (contentType: number): string => {
  const dictionary: { [key: number]: string } = {
    ...
    [CONTENT_TYPE.exam]: 'courses/images/svg/quiz_lc_icon.svg',
    ...
    [CONTENT_TYPE.flight_assessment]: 'courses/images/svg/assessment_lc_icon.svg',
    [CONTENT_TYPE.ground_assessment]: 'courses/images/svg/assessment_lc_icon.svg',
