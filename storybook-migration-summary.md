...
- `npx storybook@latest automigrate --config-dir apps/courses/.storybook --renderer @storybook/angular`

- `npx storybook@latest automigrate --config-dir apps/recent-activity/.storybook --renderer @storybook/angular`
